            ...
            <>
              ...
              <li className="max-md:w-full max-md:mb-2 md:hidden">
                <Link to={'../admin/projects'}>
                  ...
                  <span className=" text-base">المشاريع</span>
                </Link>
              </li>
              <li className="max-md:w-full max-md:mb-2 md:hidden">
                <Link to={'../admin/viewstudents'}>
                  ...
                  <span className=" text-base">عرض جميع الطلاب</span>
                </Link>
              </li>
              <li className="max-md:w-full max-md:mb-2 md:hidden">
                <Link to={'../admin/managment'}>
                  <svg
                    className="flex-shrink-0 w-5 h-5 mr-4"
                    fill="#000000"
                  ...
                  <span className=" text-base">إدارة البيانات</span>
                </Link>
              </li>
              <li className="max-md:w-full max-md:mb-2 md:hidden">
                <Link
